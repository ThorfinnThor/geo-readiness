      ...
      <main className="mx-auto flex max-w-4xl flex-col gap-10 px-6 py-12 sm:py-16">
        <header className="flex flex-col gap-4">
          ...
          <a
            ...
            className="inline-flex min-h-[44px] w-fit items-center gap-2 rounded-lg bg-[color:var(--accent)] px-4 py-2.5 text-sm font-semibold text-[color:var(--accent-fg)] transition-opacity hover:opacity-90"
          >
            {SITE.email}
          </a>
        </header>
